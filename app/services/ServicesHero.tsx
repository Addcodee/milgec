    ...
    <section ref={ref} className="relative bg-navy overflow-hidden pt-28 pb-20 md:pt-36 md:pb-28">
      ...
      <div className="relative max-w-300 mx-auto px-6 text-center">
        ...
        <div data-sh-cta className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a href="https://wa.me/8613792888176" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white/10 hover:bg-whatsapp/20 border border-white/20 text-white font-semibold text-sm px-6 py-3.5 rounded-xl transition-all backdrop-blur-sm">
