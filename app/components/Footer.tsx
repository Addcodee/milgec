        ...
        <div className="flex flex-col md:flex-row md:items-start gap-8 md:gap-12 mb-8">
          ...
          <div className="flex md:flex-col items-center gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-lg bg-white/[0.05] border border-white/[0.08] flex items-center justify-center text-white/30 hover:text-[#E4405F] hover:border-[#E4405F]/30 transition-all"
